...
export const MEDIUM_HELPER_MESSAGES = {
  ...
  "Publication" : "Copy the publication name in the link: https://medium.com/PUBLICATION", 
  "Tag" : "Copy the tag/topic name from: https://medium.com/tag/TAG",
  "Custom": "Copy the custom domain, must be a subdomain of medium. Ex: medium.datadriveninvestor.com"
}